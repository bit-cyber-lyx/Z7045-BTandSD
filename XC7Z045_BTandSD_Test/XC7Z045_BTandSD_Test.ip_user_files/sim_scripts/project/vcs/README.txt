...
#
# Generated by export_simulation on Mon Oct 25 13:59:10 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './project.sh' script.

./project.sh -reset_run
...
./project.sh -noclean_files

For more information on the script, please type './project.sh -help'.

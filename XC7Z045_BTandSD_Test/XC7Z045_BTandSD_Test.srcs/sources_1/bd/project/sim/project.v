...
(* CORE_GENERATION_INFO = "project,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=project,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "project.hwdef" *) 
module project
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_0 " *) input [6:0]GPIO_0_tri_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_0 " *) output [6:0]GPIO_0_tri_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:gpio:1.0 GPIO_0 " *) output [6:0]GPIO_0_tri_t;
  ...
  wire [6:0]processing_system7_0_GPIO_0_TRI_I;
  wire [6:0]processing_system7_0_GPIO_0_TRI_O;
  wire [6:0]processing_system7_0_GPIO_0_TRI_T;

  assign GPIO_0_tri_o[6:0] = processing_system7_0_GPIO_0_TRI_O;
  assign GPIO_0_tri_t[6:0] = processing_system7_0_GPIO_0_TRI_T;
  assign processing_system7_0_GPIO_0_TRI_I = GPIO_0_tri_i[6:0];
  project_processing_system7_0_0 processing_system7_0
